...
def main() -> int:
    ...
    parser.add_argument(
        "--notebook",
        type=Path,
        default=analysis_root / "themes/mhealth/eda/notebooks/01_eda_overview.ipynb",
        help="Notebook to execute.",
    )
    parser.add_argument(
        "--executed-dir",
        type=Path,
        default=analysis_root / "themes/mhealth/eda/executed",
    ...
    parser.add_argument(
        ...
        / "themes/mhealth/artifacts/summaries/01_eda_overview.summary.json",
    ...
    parser.add_argument(
        ...
        type=Path,
        default=analysis_root
        / "themes/mhealth/artifacts/findings/01_eda_overview.findings.txt",
        help="Output findings text path.",
    )
    parser.add_argument(
        "--state-path",
        type=Path,
        default=analysis_root / "themes/mhealth/agent/state.json",
