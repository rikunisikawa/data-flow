...
def main() -> int:
    ...
    parser.add_argument(
        "--reports-dir",
        type=Path,
        default=Path("analysis/reports/eda"),
        help="Directory containing EDA report CSV/JSON files.",
    )
    parser.add_argument(
        "--summary-path",
        type=Path,
        default=Path("analysis/themes/mhealth/artifacts/summaries/01_eda_overview.summary.json"),
        help="Output summary JSON path.",
    )
    parser.add_argument(
        "--findings-path",
        type=Path,
        default=Path("analysis/themes/mhealth/artifacts/findings/01_eda_overview.findings.txt"),
